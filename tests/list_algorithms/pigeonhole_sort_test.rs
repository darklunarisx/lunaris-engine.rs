//! Pigeonhole Sort Test Suite
//!
//! Comprehensive tests for the generic, production-grade pigeonhole_sort algorithm.
...
#[test]
fn test_pigeonhole_sort_reverse() {
...
#[test]
fn test_pigeonhole_sort_all_equal() {
...
#[test]
fn test_pigeonhole_sort_negative_numbers() {
...
#[test]
fn test_pigeonhole_sort_randomized() {
...
#[test]
fn test_pigeonhole_sort_large_random() {
    use rand::Rng;
    let mut rng = rand::thread_rng();
